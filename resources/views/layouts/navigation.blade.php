        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center text-sm font-medium text-gray-200 hover:text-yellow-200 hover:border-yellow-200 focus:outline-none focus:text-yellow-400 focus:border-yellow-300 transition duration-150 ease-in-out">
